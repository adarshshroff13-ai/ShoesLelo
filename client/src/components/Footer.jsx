...
const Footer = () => {
    const contactItems = [
        ...
        { src: "/Footer/email.png", alt: "Email", data: "ShoesLelo@gmail.com" },
        { src: "/Footer/pin.png", alt: "Address", data: "ShoesLelo, NC5 Mohali, <br />Mohali, Punjab, 140304, India" },
    ...
    return (
        <footer className='bg-gray-50 flex flex-col items-start w-full mx-auto p-4 pb-2 mt-8 text-sm'>
            ...
            <p className='mt-4 self-center'>© {new Date().getFullYear()} <span>ShoesLelo </span> | Vortex</p>
        </footer>
