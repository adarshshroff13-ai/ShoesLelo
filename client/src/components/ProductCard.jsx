    ...
    return (
        <div
            ...
            <Link to={`/product-details/${product._id}`} className='h-full' >
                ...
                {/* Img */}
                <div className='h-4/6 flex items-center justify-center overflow-hidden bg-gray-50'>
                    <img className='w-full h-full object-contain hover:scale-105 transition-transform duration-300' src={img} alt={title} />
                </div>
                {/* Title */}
                <div className='h-1/6 flex flex-col justify-end items-start xs:mt-2 md:mt-6'>
                    ...
                    {/* Rating */}
                    <div className='flex items-center gap-1 xs:text-xs md:text-sm mt-1'>
